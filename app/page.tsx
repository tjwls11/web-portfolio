...
export default function Home() {
  return (
    <div className="isolate min-h-full">
      ...
      />
      {/* 배경 위 */}
      <div className="flex flex-col justify-center items-center min-h-screen relative animate-slideUp text-center">
      ...
      {/* 배경 아래 */}
      <div className="flex flex-col justify-center items-center relative z-10 animate-slideUp text-center">
        <h1 className="text-black text-3xl font-bold mb-4">My contact</h1>

        <div className="mt-2 flex flex-row space-x-12 justify-center items-center mr-9">
